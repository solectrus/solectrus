...
#                              root GET    /(:sensor)(/:timeframe)(.:format)                         balance/home#index {:sensor=>/inverter_power|house_power|heatpump_power|grid_power|battery_power|battery_soc|car_battery_soc|wallbox_power|case_temp|autarky|self_consumption|savings|co2_reduction|custom_power_01|custom_power_02|custom_power_03|custom_power_04|custom_power_05|custom_power_06|custom_power_07|custom_power_08|custom_power_09|custom_power_10/, :timeframe=>/(\d{4}((-W\d{2})|(-\d{2}))?(-\d{2})?)|now|day|week|month|year|all/}
...
#                             top10 GET    /top10(/:period)(/:sensor)(/:calc)(/:sort)(.:format)      top10#index {:period=>/day|week|month|year/, :calc=>/sum|max/, :sort=>/asc|desc/, :sensor=>/inverter_power|house_power|heatpump_power|grid_import_power|grid_export_power|battery_charging_power|battery_discharging_power|wallbox_power|custom_power_01|custom_power_02|custom_power_03|custom_power_04|custom_power_05|custom_power_06|custom_power_07|custom_power_08|custom_power_09|custom_power_10|case_temp/}
