class ChartData::HeatpumpTankTemp < ChartData::Base
  def suggested_min
    0
  end
  ...
  def data
    @data ||= {
      ...
      datasets: [
        {
          id: 'heatpump_tank_temp',
          label: SensorConfig.x.display_name(:heatpump_tank_temp),
  ...
  def chart
    @chart ||=
      MinMaxChart.new(sensor: :heatpump_tank_temp).call(timeframe)[
        :heatpump_tank_temp,
      ]
  end
