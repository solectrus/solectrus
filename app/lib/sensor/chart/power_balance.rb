class Sensor::Chart::PowerBalance < Sensor::Chart::Base
  ...
  def chart_sensor_names
    DATA_SENSOR_NAMES.select { |name| Sensor::Config.exists?(name) }
  end
  ...
  def display_sensor_names
    @display_sensor_names ||= DISPLAY_SENSOR_NAMES.select do |name|
